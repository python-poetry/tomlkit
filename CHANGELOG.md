...
- Fix a `KeyAlreadyPresent` error when parsing, accessing, or unwrapping an out-of-order table whose later part extends the last element of an array of tables. ([#577](https://github.com/python-poetry/tomlkit/issues/577))
